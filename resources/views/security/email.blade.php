...
@section('dashboard-content')
    <div class="profile-content-card">
        <div class="d-flex align-items-center gap-2 mb-4">
            ...
            <h4 class="fw-bold mb-0">Update Email</h4>
        </div>
        ...
        <form method="POST" action="{{ route('settings.email.update') }}">
            ...
            <div class="mb-3">
                <label for="email" class="form-label small text-muted">New Email Address</label>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary-custom text-white px-4">Update Email</button>
